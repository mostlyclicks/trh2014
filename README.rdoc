...
Pull it down:
git clone https://github.com/mostlyclicks/trh01.git name_of_your_app
...
1. Replace trh01 with name_of_your_app (~9 occurences, 4 files)
2. Replace Trh01 with NameOfYourApp (~11 occurences, 10 files)
